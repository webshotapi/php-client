 ...
 * Take screenshot of website and save to JPG
 */
...
try{
    ...
    //Download, save jpg and dont show in output
    if($webshotapi->screenshot_json($URL, $params, $SAVE_PATH, false) == 200){
